...
class Polygon(Figure):
    ...
    def __init__(self, a, b, c):
        ...
        for i in self.points.array:
            for j in self.points.array:
                self._diameter = max(self._diameter, i.dist(j))
    ...
    def add(self, t):
        ...
        if t.is_light(self.points.last(), self.points.first()):
            ...
            self._area += abs(R2Point.area(t, self.points.last(),
                                           self.points.first()))
...
# нужно найти диаметр фигуры, диаметр -
# натбольшее расстояние между двумя точками
